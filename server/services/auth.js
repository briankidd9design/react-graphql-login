...
// GraphQL will handle all things related to INCOMING REQUESTS for authentication. GRAPHQL will delegate the authentcation operation to PASSPORT.
...
// If we call the signup function with an email, password, and request object, it will automatically attempt to sign up a new user for our application and then save and log them into the application
// If we import this function into our mutations file and call this signup function with the email, password and request, it will create our new user and log that user in
